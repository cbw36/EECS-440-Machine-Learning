import numpy as np
from call_logreg import *
from mldata import *



def logreg(data_path, cv, num_bins, m_estimate):
...
def parse_command_line_inputs():
    ...
    option4: value of m-estimate.  If negative, use Laplace smoothing.  If m=0, use MLE estimate.  p is fixed to 1/v for variable with v values
    ...
    return logreg(option1, option2, option3, option4)

logreg = parse_command_line_inputs()